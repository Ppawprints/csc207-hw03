...
/**
 * A Unit of measurement. The primary units available at Unit.GRAM, Unit.KILOGRAM, Unit.OUNCE, and
 * Unit.POUND.
 */
public class Unit {
  // +--------+------------------------------------------------------
  ...
  /**
   * Get the plural of the unit name. (One does not always form a plural by just adding "s", so we
   * provide this additional method.)
   */
  ...
  public boolean equals(Object other) {
    if (other instanceof Unit) {
      ...
      if (unit.name.equals(this.name) && unit.abbrev.equals(this.abbrev)
          && unit.plural.equals(this.plural))
        return true;
    }
    return false;
  }
