...
public class CartTester {
  public static void main(String[] args) {
    ...
    Package packageAmazon = new Package("amazon", new Weight(Unit.GRAM, 100), 100);
    ManyPackages manyPackageAmazon =
        new ManyPackages(new Package("amazon", new Weight(Unit.GRAM, 100), 100), 5);
    NonFood nonFoodStone = new NonFood("stone", new Weight(Unit.POUND, 200), 99);
    ...
    pen.println("equals(): " + bulkItemBananas.equals(bulkItemSaffron));
    // should be false
    pen.println();
    ...
    pen.println(
        "equals(): " + nonFoodStone.equals(new NonFood("stone", new Weight(Unit.POUND, 200), 99)));
    // should be true
    pen.println();
